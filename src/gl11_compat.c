...
void lwcgl_gluPickMatrix(GLdouble x,GLdouble y,GLdouble w,GLdouble h,IntBuffer *v){if(has(v,LWCGL_BUFFER_INT,4))gluPickMatrix(x,y,w,h,(GLint*)Buffer.address(v));}
