...
#define LWCGL_VERSION_STRING "2.9.3"
#define LWCGL_VERSION_NAME "v2.9.3"
#define LWCGL_UPSTREAM_LWJGL_VERSION "2.9.3"
...
typedef struct KeyboardAPI {
    ...
    int KEY_NONE;
    int KEY_ESCAPE;
    int KEY_1; int KEY_2; int KEY_3; int KEY_4; int KEY_5; int KEY_6; int KEY_7; int KEY_8; int KEY_9; int KEY_0;
    int KEY_MINUS; int KEY_EQUALS; int KEY_BACK; int KEY_TAB;
    int KEY_Q; int KEY_W; int KEY_E; int KEY_R; int KEY_T; int KEY_Y; int KEY_U; int KEY_I; int KEY_O; int KEY_P;
    int KEY_LBRACKET; int KEY_RBRACKET; int KEY_RETURN; int KEY_LCONTROL;
    int KEY_A; int KEY_S; int KEY_D; int KEY_F; int KEY_G; int KEY_H; int KEY_J; int KEY_K; int KEY_L;
    int KEY_SEMICOLON; int KEY_APOSTROPHE; int KEY_GRAVE; int KEY_LSHIFT; int KEY_BACKSLASH;
    int KEY_Z; int KEY_X; int KEY_C; int KEY_V; int KEY_B; int KEY_N; int KEY_M;
    int KEY_COMMA; int KEY_PERIOD; int KEY_SLASH; int KEY_RSHIFT; int KEY_MULTIPLY; int KEY_LMENU; int KEY_SPACE; int KEY_CAPITAL;
    int KEY_F1; int KEY_F2; int KEY_F3; int KEY_F4; int KEY_F5; int KEY_F6; int KEY_F7; int KEY_F8; int KEY_F9; int KEY_F10;
    int KEY_NUMLOCK; int KEY_SCROLL; int KEY_NUMPAD7; int KEY_NUMPAD8; int KEY_NUMPAD9; int KEY_SUBTRACT;
    int KEY_NUMPAD4; int KEY_NUMPAD5; int KEY_NUMPAD6; int KEY_ADD; int KEY_NUMPAD1; int KEY_NUMPAD2; int KEY_NUMPAD3; int KEY_NUMPAD0; int KEY_DECIMAL;
    int KEY_F11; int KEY_F12; int KEY_F13; int KEY_F14; int KEY_F15;
    int KEY_KANA; int KEY_CONVERT; int KEY_NOCONVERT; int KEY_YEN; int KEY_NUMPADEQUALS; int KEY_CIRCUMFLEX; int KEY_AT; int KEY_COLON;
    int KEY_UNDERLINE; int KEY_KANJI; int KEY_STOP; int KEY_AX; int KEY_UNLABELED; int KEY_NUMPADENTER; int KEY_RCONTROL; int KEY_NUMPADCOMMA;
    int KEY_DIVIDE; int KEY_SYSRQ; int KEY_RMENU; int KEY_PAUSE; int KEY_HOME; int KEY_UP; int KEY_PRIOR; int KEY_LEFT; int KEY_RIGHT;
    int KEY_END; int KEY_DOWN; int KEY_NEXT; int KEY_INSERT; int KEY_DELETE; int KEY_CLEAR; int KEY_LMETA; int KEY_RMETA; int KEY_LWIN; int KEY_RWIN;
    int KEY_APPS; int KEY_POWER; int KEY_SLEEP;
...
extern const BufferUtilsAPI BufferUtils;
extern const BufferAPI Buffer;
extern const DisplayAPI Display;
extern const KeyboardAPI Keyboard;
extern const MouseAPI Mouse;
extern const SysAPI Sys;
...
#ifdef LWCGL_ENABLE_LWJGL2_COMPAT
#include <lwcgl/lwjgl2_compat.h>
#endif
